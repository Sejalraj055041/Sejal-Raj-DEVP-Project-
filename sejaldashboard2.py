...
data_path = r"C:\Users\sejal\Downloads\Sejal Python\Imports_Exports_Dataset.csv"  # Modify the path as needed
...
# Sample dataset
sdset = dataset.sample(n=min(3001, len(dataset)), random_state=55041)  # Adjust to actual length
...
if selected_chart == "Payment Method Distribution":
    ...
    fig_map.update_layout(
        ...
        width=1400,  # Increase width to match the black background
